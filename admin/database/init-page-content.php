...
try {
    ...
    $ruContent = [
        ...
        'meta' => [
            ...
            'events_dates_comment' => 'Даты будут добавлены динамически',
            'events_posters_comment' => 'Постеры будут добавлены динамически',
            'gallery_comment' => 'Получаем изображения галереи из БД',
            'gallery_db_comment' => 'Используем изображения из БД',
            'gallery_fallback_comment' => 'Fallback на статичные изображения',
    ...
    $enContent = [
        ...
        'meta' => [
            ...
            'events_dates_comment' => 'Dates will be added dynamically',
            'events_posters_comment' => 'Posters will be added dynamically',
            'gallery_comment' => 'Getting gallery images from database',
            'gallery_db_comment' => 'Using images from database',
            'gallery_fallback_comment' => 'Fallback to static images',
...
<p>Tại North Republic, mỗi người sẽ tìm thấy cách tận hưởng thời gian lý tưởng của riêng mình: từ các cuộc phiêu lưu cho đội nhóm công ty đến những bữa tối lãng mạn dưới bầu trời đầy sao, từ các bữa tiệc cho trẻ em đến những cuộc trò chuyện triết lý bên lò sưởi. Đây là nơi những tình bạn mới được nảy nở, tình cảm gia đình thêm bền chặt và những kỷ niệm đáng nhớ được tạo nên cho cả cuộc đời.</p>',
            ...
            'events_dates_comment' => 'Ngày sẽ được thêm động',
            'events_posters_comment' => 'Áp phích sẽ được thêm động',
            'gallery_comment' => 'Lấy hình ảnh thư viện từ cơ sở dữ liệu',
            'gallery_db_comment' => 'Sử dụng hình ảnh từ cơ sở dữ liệu',
            'gallery_fallback_comment' => 'Dự phòng cho hình ảnh tĩnh',
