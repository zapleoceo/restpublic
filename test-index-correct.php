...
try {
    ...
    if (class_exists('MongoDB\Client')) {
        ...
        echo "4. Categories type: " . gettype($categories) . "\n";
        echo "5. Products type: " . gettype($products) . "\n";
        
        // Group products by category for quick access and sort by popularity
        if ($products) {
            echo "6. Processing products...\n";
            ...
            echo "7. Products grouped by category:\n";
            ...
            echo "8. After sorting and limiting to top 5:\n";
            foreach ($productsByCategory as $catId => $catProducts) {
                echo "    Category $catId: " . count($catProducts) . " products\n";
