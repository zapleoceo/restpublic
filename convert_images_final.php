...
// Правильные пути к изображениям (включая файл с пробелом)
$images = [
    '/var/www/northrepubli_usr/data/www/northrepublic.me/images/intro-pic-primary.jpg',
    '/var/www/northrepubli_usr/data/www/northrepublic.me/images/intro-pic-primary (1).jpg',
...
foreach ($images as $image) {
    if (file_exists($image)) {
        ...
        if ($fileSize == 0) {
            echo "⏭️  Пропускаю пустой файл: " . basename($image) . "\n";
            continue;
        }
